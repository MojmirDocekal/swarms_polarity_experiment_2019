...
["practice", aj, {s: {html: "<p>Kontext: Správce tržiště Aleš dobře zná všechny stánkaře, kteří tu kdy prodávali. Průměrně tu bývá denně asi 50 stánkařů. Dnes je na tržišti přesně 50 stánkařů. Aleš volá informaci o situaci na tržišti svému nadřízenému. A do telefonu říká následující větu. </p><p><center>Věta: <i>Dneska se tržiště úplně hemží stánkaři.</i></p></center><p>Vaším úkolem v experimentu bude na škále 1 (Věta je naprosto v rozporu s kontextem a/nebo je nepřijatelná) až 5 (Věta je naprosto v souladu s kontextem a je přijatelná) ohodnotit vhodnost Alešovy věty vůči původnímu kontextu. Alešova věta odpovídá kontextu a je to přijatelná česká věta; vyberte jako odpověď jednu z možností v pravém konci škály (nejspíš 5).</p>"}, leftComment: "(Věta je naprosto v rozporu s kontextem a/nebo je negramatická)", rightComment: "(Věta je naprosto v souladu s kontextem a je přijatelná)"}],
